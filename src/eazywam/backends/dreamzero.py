...
class DreamZeroBackend(NativeBackendBase):
    ...
    def _connect_client(
        ...
        try:
            client_module = importlib.import_module(
                "eazywam.compat.dreamzero_eval.policy_client"
            )
    ...
    def _server_module(self) -> str:
        ...
        if self._config_bool("disable_torch_compile", default=True):
            return "eazywam.compat.dreamzero_eval.serve_dreamzero_no_compile"
        defaults = self.eval_defaults()
    ...
    def _server_module_repo_path(self) -> str:
        ...
        if module == "eazywam.compat.dreamzero_eval.serve_dreamzero_no_compile":
